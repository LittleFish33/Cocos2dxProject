...
| ------------------------------ | --------------- | -------------------------- | --------- |
| 本文档的编写                   | 1%              | 邱晓裕                     |           |
| 建立整个项目基本的类文件和框架 | 15%             |                            | 6/16-6/18 |
| 第一个精灵                     | 14%             |                            | 6/19-6/23 |
| 美化界面 + 音乐                | 13%             |                            | 6/24-6/28 |
| 其他精灵的制作                 | 15%（每人占5%） | 除了选择第一个精灵任务的人 | 6/24-6/28 |
| 合并代码                       | 6%              |                            | 6/29-7/1  |
| 双人对战                       | 7%              |                            | 7/1-7/4   |
| 设置排行榜                     | 7%              |                            | 7/4-7/8   |
| 定期刷怪                       | 4%              |                            | 6/24-6/28 |
...
* 关于时间的安排，其实可以互相协调然后提早开始的：比如说设置排行榜的人，可以先找双人对战的人提供得到分数的接口，然后就可以先写啦，啦啦啦。
* 下面的是附加功能，炫技项啊啊啊
...
现在就要实现整个游戏的最重要的功能了；你需要在前面的合并好的代码上，完成两个角色对打的功能；上面应该已经基本完成了这部分需要使用的函数，这里要做的也就是碰撞的时候调用对应的函数，死亡的时候调用对应的函数就好了，播放死亡动画，还有计算两个玩家的得分，倒计时，应该不是很难吧。。。。
